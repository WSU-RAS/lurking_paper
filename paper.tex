...
having an in-home nurse has become more impractical. \cite{UNProspects2017} 
Robotic assistance for the elderly is a promising solution, allowing people to 
age in-place independently. A robotic assistant would, potentially, be able to 
remind the user of day to day tasks and guide them through tasks if they have 
difficulty. One problem in robotic assistance is the question of where the 
robot should be when no intervention is needed. In order to be effective, the 
